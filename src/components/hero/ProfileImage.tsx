...
const ProfileImage: React.FC = () => {
  return (
    <div className="relative w-80 h-80 overflow-visible">
      {/* Animated circle effects - behind the image */}
      ...
      {/* Profile Image - positioned to show head above circle, clipped at bottom */}
      <div className="absolute -top-12 left-0 w-80 h-80 z-20">
        <img 
          src="/lovable-uploads/ac05b5d9-c668-494e-9575-2f216c149e65.png" 
          alt="Yeheskiel Yunus Tame - Blockchain & AI Developer" 
          className="w-80 h-80 object-cover object-top shadow-2xl"
          style={{
            clipPath: "circle(160px at 50% 75%)"
          }}
        />
      </div>
