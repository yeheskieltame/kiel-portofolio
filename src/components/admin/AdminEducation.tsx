...
export const AdminEducation = () => {
  ...
  const handleAddEducation = () => {
    ...
    // Remove id from courses for new education since they'll be generated by the database
    const educationToAdd = {
      ...newEducation,
      courses: newEducation.courses.map(({ id, ...course }) => course)
    };
