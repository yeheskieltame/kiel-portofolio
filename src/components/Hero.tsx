      ...
      <div className="max-w-7xl mx-auto text-center flex flex-col md:flex-row items-center gap-12 justify-between relative z-10">
        ...
        <div className="md:flex-1 flex justify-center items-center">
          <div className="relative w-80 h-80">
            ...
            {/* Circle borders and effects - behind the top part of image */}
            <div className="absolute top-12 left-0 w-80 h-80 z-10">
              {/* Animated rings */}
              ...
              {/* Circle mask for bottom part of image */}
              <div className="absolute inset-0 rounded-full border-4 border-white/20 bg-transparent"></div>
            </div>
